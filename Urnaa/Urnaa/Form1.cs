...
namespace Urnaa
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            _dicCandidato.Add("02", new Candidato() { Id = 02, Nome = "Jimmy Tong", Partido = "Terno" });
            _dicCandidato.Add("98", new Candidato() { Id = 98, Nome = "Insperto Lee", Partido = "Rush" });
            _dicCandidato.Add("10", new Candidato() { Id = 10, Nome = "Mr. Han", Partido = "Karatê" });
